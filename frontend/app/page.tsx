      ...
      <div className="container mx-auto py-12 space-y-16">
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            Explore comprehensive theme specimens across different industries. Each theme showcases production-ready UI
            patterns with distinct visual identities and interaction philosophies.
          </p>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {Object.entries(themes).map(([key, theme], index) => {
            ...
            const secondaryColor = getThemeTokens(key, "light")["--muted"] || "hsl(var(--muted))"

            return (
              <Link key={key} href={`/styleguide/theme-reference/${key}`} className="group">
                <Card className="h-full hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 hover:-translate-y-1 border-0 bg-card/50 backdrop-blur-sm">
                  <CardHeader className="pb-4">
                    ...
                    <CardDescription className="text-sm leading-relaxed">{theme.description}</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-2">
                        <div className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Theme</div>
                        <div className="flex gap-2">
                          <div
                            className="w-8 h-8 rounded-md shadow-sm ring-1 ring-black/5"
                            style={{ backgroundColor: getThemeTokens(key, "light")["--accent"] || primaryColor }}
                            title="Accent"
                          />
                          <div
                            className="w-8 h-8 rounded-md shadow-sm ring-1 ring-black/5"
                            style={{
                              backgroundColor: getThemeTokens(key, "light")["--border"] || "hsl(var(--border))",
                            }}
                            title="Border"
                          />
                        </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-center gap-3">
                  ...
                  <span>Semantic CSS variables with automatic theme adaptation</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-primary rounded-full" />
                  <span>Production-ready components with accessibility built-in</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-primary rounded-full" />
                  <span>Industry-specific color palettes and interaction patterns</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-primary rounded-full" />
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-center gap-3">
                  ...
                  <span>Complete app specimens with realistic data and interactions</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-secondary rounded-full" />
                  <span>Token panels showing CSS variable mappings to Radix colors</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-secondary rounded-full" />
                  <span>Design guidance with philosophy and implementation notes</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-secondary rounded-full" />
