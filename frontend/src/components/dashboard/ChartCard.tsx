...
export function ChartCard({ 
  ...
  return (
    ...
    >
      <Card className="relative overflow-hidden bg-card/80 backdrop-blur-2xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-border/50">
        ...
        <CardHeader className="relative pb-4">
          <CardTitle className="flex items-center gap-3 text-lg font-semibold">
            <motion.div
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-muted/50 text-primary"
              whileHover={{ 
                rotate: 360,
                scale: 1.1
              }}
